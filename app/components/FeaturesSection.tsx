...
const features = [
  ...
  { icon: 'ph:cube-transparent', title: 'Google Imagen 3 & Nano Banana Support', desc: "Reverses Google Gemini's exact transparent alpha blending formula for Imagen 3 photos and Nano Banana watermark variants with zero blur." },
  { icon: 'ph:video', title: 'Gemini Video Watermark Remover for Veo', desc: 'Remove Gemini watermark from Veo MP4 videos frame-by-frame with high-speed rendering and original audio track preservation.' },
